...
from .views import CitaViewSet, TratamientoViewSet, test_email, test_email_paciente, diagnostico_email
...
urlpatterns = [
    ...
    path('diagnostico-email/', diagnostico_email, name='diagnostico_email'),
] 